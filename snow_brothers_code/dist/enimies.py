...
RedDemon_animation_names = ['Dead', 'Idle', 'Walk']
...
class RedDemon:
    ...
    def update(self):
        ...
        if self.R_Is_Meet_Wall == False:
            self.y -= 1.5
            self.R_Is_Meet_Wall = True

        self.R_Is_Meet_Wall = False
    ...
    def handle_collision(self, other, group):
        if group == 'attack:enimies':
            self.bgm = load_wav('Enimies_Dead.wav')
...
class Frog:
    ...
    def update(self):
        ...
        if self.F_Is_Meet_Wall == False:
            self.y -= 1.5
            self.F_Is_Meet_Wall = True

        self.F_Is_Meet_Wall = False
...
class Yellow_Troll:
    ...
    def update(self):
        ...
        if self.Y_Is_Meet_Wall == False:
            self.y -= 1.5
            self.Y_Is_Meet_Wall = True

        self.Y_Is_Meet_Wall = False
